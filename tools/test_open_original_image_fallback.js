...
(async()=>{
  ...
  assert.strictEqual(sandbox.location.href,'original://source','fallback should navigate to original src when conversion fails');
  console.log('openOriginalImage fallback regression passed');
